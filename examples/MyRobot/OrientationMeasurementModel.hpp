#ifndef KALMAN_EXAMPLES_MyRobot_ORIENTATIONMEASUREMENTMODEL_HPP_
#define KALMAN_EXAMPLES_MyRobot_ORIENTATIONMEASUREMENTMODEL_HPP_
...
public:
    ...
    typedef  KalmanExamples::MyRobot::OrientationMeasurement<T> M;
