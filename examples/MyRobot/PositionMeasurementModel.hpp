#ifndef KALMAN_EXAMPLES_MyRobot_POSITIONMEASUREMENTMODEL_HPP_
#define KALMAN_EXAMPLES_MyRobot_POSITIONMEASUREMENTMODEL_HPP_
...
public:
    ...
    typedef  KalmanExamples::MyRobot::PositionMeasurement<T> M;
